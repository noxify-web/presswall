import {
  PRESSWALL_APP_HANDLE,
  PRESSWALL_EMBED_BLOCK_HANDLE,
  PRESSWALL_SECTION_BLOCK_HANDLE,
  PRESSWALL_THEME_EXTENSION_UID,
} from "@/lib/theme-extension";

const EXTENSION_UID = PRESSWALL_THEME_EXTENSION_UID;
const APP_HANDLE = PRESSWALL_APP_HANDLE;
const EMBED_BLOCK_HANDLE = PRESSWALL_EMBED_BLOCK_HANDLE;
const SECTION_BLOCK_HANDLE = PRESSWALL_SECTION_BLOCK_HANDLE;
